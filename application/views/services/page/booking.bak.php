        ...
        <div class="content-block">
            ...
            <div class="row">
                <div class="ten columns centered smallpadding">
                    <form id="booking-form" action="<?= base_url(); ?>services/automobile/booking.json" method="post"
                            ...
                            <ul>
                                ...
                                <li class="row">
                                    <div class="twelve columns field">
                                        ...
                                        <input type="text" class="input" name="vin_number" value="<?php echo @$this->member->vin_number;?>">
                                    </div>
                                </li>
                                <li class="row">
                                    <div class="twelve columns field">
