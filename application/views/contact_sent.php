        ...
        <div class="content-block dark black-tint">
            <div class="row large">
                ...
                <!-- intro statement -->
                    ...
                    <h4>Kami telah menerima inquiry Anda. untuk respon yang lebih cepat.<br>Hubungi
                    <br>HALO SUZUKI : 0800-1100-800 (bebas pulsa)<br> <span style="font-size:70%;">Jam Kerja 08.00 - 17.00 WIB</span>                    
                    </h4>
