...
<div class="header navbar navbar-fixed-top">
	...
	<!-- BEGIN LOGO -->
	<a class="navbar-brand" href="<?php echo base_url();?>" target="_blank"><img src="<?php echo base_url('assets/static/img/'.$this->logo->value);?>" alt="<?php echo $this->site_name->value;?>" class=""/></a>
	<!-- END LOGO -->
	...
	<ul class="nav navbar-nav pull-right">
		...
		<ul class="dropdown-menu">
		    <li><a href="<?php echo base_url(ADMIN);?>/user/view/<?php echo $this->acl->user()->id;?>"><i class="fa fa-user"></i> <?php echo lang('profile');?></a></li>
		    <li><a href="javascript:;"><i class="fa fa-lock"></i> <?php echo lang('last_login');?> <?php echo date('Y-m-d, H:i:s',$this->acl->user()->last_login);?></a></li>
		    <li><a href="<?php echo base_url(ADMIN)?>/authenticate/logout"><i class="fa fa-key"></i> <?php echo lang('logout');?></a></li>
		</ul>
	    </li>
