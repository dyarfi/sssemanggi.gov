...
<div class="action step-right">
	...
	<section id="intro" class="img-section" style="background:url(<?php echo base_url('uploads/motorcycle/'.str_replace($detail->media, 'thumb__1192x671'.$detail->media, $detail->media));?>) no-repeat;">
		<div class="">
				...
				<div class="row large light">
					<div class="six columns">
						...
						<h6 class="sub-heading">
							...
							<a href="<?php echo base_url('motorcycle');?>">Motorcycle</a> <i class="fa fa-chevron-right" aria-hidden="true"></i>
			...
			<div class="detail-produk content-block">
				<div class="row large">
					<div class="eleven columns">
						<!-- intro statement -->
						<img src="<?php echo base_url('uploads/motorcycle/'.$detail->cover);?>" alt="" class="logo-product">
						...
						<div class="midtoppadding box-middle-handler">
							<ul class="prodinfo">
								...
								<li><a href="http://www.suzuki.co.id/dealers/#!/pilih_jenis=roda-2" class="purple fill-button" target="_blank"><span class="fa fa-map-marker" aria-hidden="true"></span> TEMUKAN DEALER</a></li>
		...
		<div class="content-block nopadding">
			<div class="row headinfo">
				<div class="two columns">
					<img src="<?php echo base_url('uploads/motorcycle/'.$detail->cover);?>" alt="" style="padding-top:5px;"/>
				</div>
					...
					<div class="row navbar" id="nav1">
						<ul class="eight columns">
							<li>
								...
								<div class="dropdown">
                                    <ul>
                                        <li><a href="http://www.sfi.co.id/simulasi_kredit.htm" target="_blank">Suzuki Finance Indonesia</a></li>
                                        <li><a href="http://www.nabungtanpauang.com/order/adiracoid" target="_blank">Adira Finance</a></li>
                                        ...
                                        <li><a href="https://www.otofinance.co.id/" target="_blank">Oto Finance</a></li>
                                        <li><a href="http://www.csf.co.id/?ver=" target="_blank">CSFinance</a></li>
                                        <li><a href="http://mandalafinance.com/en/" target="_blank">Mandala Finance</a></li>
                                        <li><a href="http://www.wom.co.id/" target="_blank">WOM Finance</a></li>
                                    </ul>
								</div>
							</li>
						</ul>
                ...
                <div class="ten columns centered nopadding">
                    ...
                    <div class="row nopadding">
                        <div class="twelve columns centered text-center">
                            <?php
                            $variants = $this->ProductVariants->findAll(['product_id'=>$detail->id],'*',['priority'=>'ASC']);
                            if($variants) {
                            //if ($detail->variant) {
                            ?>
                            <div class="flexslider img-nav-slider">
                                <ul class="slides">
                                    ...
                                    <li class="variant">
                                        ...
                                        <p><img src="<?php echo base_url($variant->media);?>" gumby-retina/></p>
                            ...
                            <img src="<?php echo base_url('uploads/motorcycle/'.$detail->media_plain);?>" alt="<?php echo $detail->subject;?>"/>
                            <?php } ?>
                            <!--div class="img-nav"></div-->
                            <?php if ($variants) { ?>
                            <ol class="img-slider-nav do-six">
                                <?php foreach ($variants as $color) {
                                    $color = $this->ProductColors->get($color->color_id);
                                    ?>
                                    <li class="nav-button">
                                        <a href="#"><img src="<?php echo base_url('assets/public/images/picker/'.$color->media);?>" class="img-responsive"/></a>
                                    </li>
                                <?php } ?>
                            </ol>
                            <?php } ?>
                    ...
                    <?php
                        ...
                        <?php
                            foreach ($attributes as $attribute => $key) {
                                ...
                                <hr class="thin grey">
                                <h5 class="bold purple-text"><span class="fa fa-play icondetail" aria-hidden="true"></span><?php echo strtoupper(str_replace('_', ' ',$attribute));?></h5>
                                <div class="row nopadding">
                                <?php
                                $i=1;
                                ...
                                <?php
                                    ...
                                    <div class="row nopadding">
                                        <?php
                                        $j=11;
                                        foreach ($key as $key => $obj) {
                                            if ($obj->value) {?>
                                            <div class="drawer-title ">
                                                <a href="#" class="toggle" gumby-trigger="#drawer<?php echo $j;?>"><?php echo ucfirst(str_replace('_', ' ', $obj->label));?></a>
                                            </div>
                                            <div class="drawer drawer-content" id="drawer<?php echo $j;?>">
                                                <div class="content-block">
                                                    <div class="row">
                                                    <p>
                                                        <?php echo strip_tags($obj->value,'<img>');?>
                                                    </p>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="pera-modal custom-scroll">
    <div id="pera-scrollarea">
        <div class="content-block nopadding">
            <div class="row headinfo">
                <div class="two columns">
                    <img src="<?php echo base_url('uploads/motorcycle/'.$detail->cover);?>" alt="" class="logo-product" style="padding-top:10px; padding-bottom: 2px;">
                </div>
            </div>
            <div class="row nopadding">
                <div class="ten columns centered nopadding">
