...
// Class for language label
class LanguageLabel extends Admin_Controller {
	...
	public function index() {	
        ...
        // Set language query 
        $query = $this->input->get('lang');

        // Query language
        $data['languages'] = $this->Languages->getAllLanguage(['status'=>'publish']); 

	    $rows = $this->Labels->getAllLabel(['lang_id'=>$this->i18ln->id]);
	    ...
	    // Main template
	    $data['main'] = 'language/label_index';
