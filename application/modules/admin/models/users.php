...
class Users Extends CI_Model {
	...
	public $belongs_to = ['groups' => [
							// Set relation Model
							'model' => 'admin/UserGroups',
	...
	// Authenticate function for user login by username
	...
	// Authenticate function for user login by email
	public function loginEmail($object=null){		
	    if(!empty($object)){
		$data = array();
		$options = array(
				'email' => $object['email'], 
	...
	public function setUser($object=null){
	    ...
	    if ($insert_id) {
			...
			$this->email->message('Hey <b>'.$object['username'].'</b>, this is your new password: <b>'.$object['password'].'</b>');
			$this->email->send();
		    ...
		    $data = array(
				    'user_id'	=> $insert_id,
				    'gender'	=> !empty($object['gender']) ? $object['gender'] : '1',
