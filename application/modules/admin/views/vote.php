		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Vote Controls <small>{TITLE}</small>
					</h3>
					...
					<div class="portlet box blue">
							...
							<div class="actions">
								<div class="btn-group">
									...
									<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
										...
										<label><input type="checkbox" checked data-column="1">City</label>
										<label><input type="checkbox" checked data-column="2">Total Vote</label>
										<label><input type="checkbox" checked data-column="3">Preview</label>
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									 <?=$this->vote_model->count_vote_by_id($med['id'])?>
								</td>
								<td>
									 <?=$med['media_link']?>
								</td>
