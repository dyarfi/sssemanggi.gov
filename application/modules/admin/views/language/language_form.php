		...
		<div class="col-md-12">
			...
			<li>
			    <a href="<?php echo base_url(ADMIN.$class_name);?>/index">
				    <?php echo lang('Languages');?> Control
			    </a>
			    <i class="fa fa-angle-right"></i>
			</li>
			<li>
		...
		<div class="form-body">
			...
			<div class="col-md-6">
				...
				<div class="col-md-9">
					...
					<input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo $fields->name;?>" id="name">
				    </div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-9">
				    <div class="input-group">
					<input type="text" class="form-control" name="url" placeholder="Url" value="<?php echo $fields->url;?>" id="url">
				    </div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-9">
				    <div class="input-group">
					<input type="text" class="form-control" name="prefix" placeholder="Prefix" value="<?php echo $fields->prefix;?>" id="prefix">
				    </div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-9">
				    <div class="input-group">
					<input type="text" class="form-control" name="native" placeholder="Native" value="<?php echo $fields->native;?>" id="native">
				    </div>
			...
			<div class="col-md-6">							
				...
				<div class="col-md-9">
				    <div class="input-group">
					<input type="file" class="form-control input-icon" name="file_name" placeholder="File Name" value="<?php echo $fields->file_name;?>" id="file_name">
				    </div>
		...
		<div class="form-actions fluid">
			...
			<div class="col-md-6">
			    <div class="col-md-offset-3 col-md-9">
					<button class="btn green" type="submit"><?php echo lang('Submit');?></button>
