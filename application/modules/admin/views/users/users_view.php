										...
										<li>
											...
											<div class="img_holder_xhr">
												<div class="img-thumbnail">
													...
													<?php } else {?>
														<img alt="" src="<?php echo base_url($upload_url.$user_profile->file_name);?>">
													<?php } ?>
													</a>
												</div>
											</div>
								...
								<div class="col-md-8 col-lg-8">
									<div class="row">
										<div class="col-md-8 profile-info">
											...
											<p><?php echo $user_profile->about;?></p>
											<p><a href="#"><?php echo $user_profile->website;?></a></p>
											<ul class="list-inline">
												<?php if(!empty($user_profile->phone)) { ?>
												<li><i class="fa fa-phone"></i> <?php echo $user_profile->phone;?></li>
												<?php } ?>
												<?php if(!empty($user_profile->mobile_phone)) { ?>
												<li><i class="fa fa-mobile-phone"></i> <?php echo $user_profile->mobile_phone;?></li>
												<?php } ?>		
												<?php if(!empty($user_profile->division)) { ?>												
												<li><i class="fa fa-briefcase"></i> <?php echo $user_profile->division;?></li>
												<?php } ?>												
											</ul>
										</div>
										<!--end col-md-8-->										
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab_1-1">
											<form action="" method="POST" id="user-form" class="user-form">
												<input type="hidden" value="<?php echo $user_profile->user_id;?>" name="user_id"/>
												<div class="form-group">
													<label class="control-label">First Name</label>
													<input type="text" class="form-control" name="first_name" placeholder="<?php echo $user_profile->first_name;?>" value="<?php echo $user_profile->first_name;?>">
												</div>
												<div class="form-group">
													<label class="control-label">Last Name</label>
													<input type="text" class="form-control" name="last_name" placeholder="<?php echo $user_profile->first_name;?>" value="<?php echo $user_profile->last_name;?>">
												</div>												
												<div class="form-group">
													<label class="control-label">Phone Number</label>
													<input type="text" class="form-control" name="phone" placeholder="<?php echo $user_profile->phone;?>" value="<?php echo $user_profile->phone;?>">
												</div>
												<div class="form-group">
													<label class="control-label">Mobile Number</label>
													<input type="text" class="form-control" name="mobile_phone" placeholder="<?php echo $user_profile->mobile_phone;?>" value="<?php echo $user_profile->mobile_phone;?>">
												</div>
												<!--div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="division" placeholder="<?php echo $user_profile->division;?>" value="<?php echo $user_profile->division;?>">
												</div>
												<div class="form-group">
													<label class="control-label">About</label>
		<textarea name="about" placeholder="<?php echo $user_profile->about;?>" rows="3" cols="5" class="form-control"><?php echo $user_profile->about;?></textarea>
												</div>
												<div class="form-group">
													<label class="control-label">Website</label>
													<input name="website" type="text" class="form-control" placeholder="<?php echo $user_profile->website;?>" value="<?php echo $user_profile->website;?>">
												</div>
												<div class="form-group">
										...
										<form action="#" id="user-form-password" class="user-form-password">											<input type="hidden" class="form-control" id="user_id" name="user_id" value="<?php echo $user->id;?>">	
