					...
					<tbody role="alert" aria-live="polite" aria-relevant="all">						
						...
						<tr class="odd gradeX <?php echo ($i % 2) ? 'even' : 'odd'; ?>">
							...
							<ul class="list-inline">
								<?php if ($row->id != $this->acl->user()->id) { ?>							    
							    <li><a class="btn default btn-xs blue" href="<?php echo base_url(ADMIN.$class_name.'/view/'.$row->id);?>" title="<?php echo lang('View');?>">
								<i class="fa fa-check"></i><?php echo lang('View');?></a>
							    </li>
							    <li><a class="btn default btn-xs purple" href="<?php echo base_url(ADMIN.$class_name.'/edit/'.$row->id);?>" title="<?php echo lang('Edit');?>">
								<i class="fa fa-edit"></i><?php echo lang('Edit');?></a>
							    </li>
							    <li><a class="btn default btn-xs red" href="<?php echo base_url(ADMIN.$class_name.'/delete/'.$row->id);?>" title="<?php echo lang('Delete');?>">
