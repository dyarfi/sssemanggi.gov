                            ...
                            <tr id="row_<?php echo $row->id; ?>" class="<?php echo ($i % 2) ? 'even_row' : 'odd_row'; ?>">
                                ...
                                <td align="left">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php echo lang(ucwords($row->module_name)); ?>
                                    <?php endif; ?>
                                    </a>
                                </td>
                                <?php 
                                    ...
                                    foreach ($module_permission as $permission):									
                                        ...
                                        <tr class="<?php echo ($j % 2) ? 'white_row' : 'green_row'; ?>" style="border:0px solid #eee !important">
                                            ...
                                            <td align="left">
                                                ...
                                                <span data-toggle="tooltip" data-placement="top" title="<?php echo lang($module_merge[$permission->module_link]);?>" class="tooltips">
                                                    <?php // echo lang($module_merge[$permission->module_link]);?>
                                                    <?php echo $permission->module_link;?>
                                                </span>
                                            </td>
                                        </tr>
                                        <?php endif;?>
