...
class Dealer extends Admin_Controller {
    ...
    public function index() {
        try {
            ...
            // Set tables
            $crud->set_table($this->Dealers->table);
            // Set CRUD subject
            ...
            // Set column
            $crud->columns('subject','text','file_name','province','categories','tags','company_phone','job_expires','geolocation_lat','geolocation_long','tambahan_body_paint','status');
            
            // Set fields
            $crud->fields('subject','url','text','file_name','province','categories','tags','company_phone','job_expires','geolocation_lat','geolocation_long','tambahan_body_paint','status');
