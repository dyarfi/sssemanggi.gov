...
class Promo extends Admin_Controller {
    ...
    public function index() {
	    ...
	    // Set our Grocery CRUD
            ...
            $crud->where('type','promo');
            // Or Where
            $crud->or_where('type','svc-artc');                      
            // Order by Listing
			...
			$crud->callback_add_field('type',array($this,'_callback_field_type'));            
			// This callback escapes the default auto field output of the field name at the add/edit form. 
			...
			$crud->display_as('media','Image')->display_as('is_highlight', 'Highlight');
	...
	public function _callback_field_type($value = '', $primary_key = null) {
		...
		return '<input type="hidden" maxlength="50" value="promo" name="type">';
	}
