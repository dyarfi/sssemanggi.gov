...
class DealerNews extends Admin_Controller {
	...
	public function _callback_field_type($value = '', $primary_key = null) {
		...
		return '<input type="hidden" maxlength="50" value="dealer" name="type">';
	}
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            // Set Media Title 
            $output->page_title = lang('Dealer News').' Listings';
            // Set Main Template
