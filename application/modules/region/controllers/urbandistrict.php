...
class UrbanDistrict extends Admin_Controller {
    
    public function __construct() {
            parent::__construct();

            // Load Participant model
            //$this->load->model('region/UrbanDistrict');
    ...
    public function index() {
	    ...
	    // Set our Grocery CRUD
            ...
            // Set tables
            $crud->set_table('tbl_urban_districts')->order_by('name','ASC');
            // Set CRUD subject
            $crud->set_subject('Urban District');                            
            // Set table relation
            $crud->set_relation('province_id','tbl_provinces','name',null,'name ASC');
            // Set column
            $crud->columns('name','province_id');			
			// Set column display 
			$crud->display_as('province_id','Province');
			// Set column display 
			$crud->display_as('name','Urban District');
            // The fields that user will see on add and edit form
            $crud->fields('name','province_id','added','modified');
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            ...
            $output->page_title = 'Urban District Listings';
            // Set Main Template
