...
class District extends Admin_Controller {
    ...
    public function __construct() {
            ...
            //$this->load->model('region/District');
    ...
    public function index() {
	    ...
	    // Set our Grocery CRUD
            ...
            // Set tables
            $crud->set_table('tbl_districts');
            // Set CRUD subject
            $crud->set_subject('District');                            
            // Set table relation
            $crud->set_relation('sub_urban_id','tbl_sub_urbans','name',null,'name ASC');
            // Set column
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            ...
            $output->page_title = 'District Listings';
            // Set Main Template
