...
class ContactEnquiry extends Admin_Controller {
    ...
    public function index() {
        try {
            ...
            // Set tables
            $crud->set_table('tbl_contact_histories')->where('type','enquiry')->order_by('added','DESC');
            // Set CRUD subject
            $crud->set_subject(lang('Contact Enquiry'));
            // Set columns
            $crud->columns('name','subject','subject_to','email','phone','address','message','added');
			// The fields that user will see on add and edit form
			$crud->fields('name','subject','email','address','message','added','modified');
            ...
            // Load Grocery Crud
            $this->load($crud, 'contact_enquiry');
        } catch (Exception $e) {
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            ...
            $output->page_title = lang('Contact Enquiry');
            // Set Main Template
