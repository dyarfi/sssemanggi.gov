...
// Model Class Object for Models
class ProductModels Extends MY_Model {

	// Table name for this model
	public $_table = 'product_models';
    ...
    public function getModelByProductId($options = null,$limit=''){
	    if(!empty($options)){
		$data = array();
	...
	public function getModelByType($type = null){
		if(!empty($type)){
			$data = array();
	...
	public function getModelByUrl($type=null, $url = null){
	...
	public function getModelByName($name = null){
		if(!empty($name)){
			$data = array();
	...
	public function getAllModel($admin=null){
		$data = array();
	...
	public function setModel($object=null){
