...
class Templates Extends CI_Model {
	...
	public function getTemplatePage($id = null){
		if(!empty($id)){
			$data = array();
			$options = array('id' => $id);
    ...
    public function getTemplateByCategoryId($options = null,$limit=''){
	    if(!empty($options)){
		$data = array();
	...
	public function getTemplateByType($type = null){
		if(!empty($type)){
			$data = array();
	...
	public function getTemplateByUrl($type=null, $url = null){
	...
	public function getTemplateByName($name = null){
		if(!empty($name)){
			$data = array();
	...
	public function getAllTemplatePages($admin=null){
		$data = array();
	...
	public function getAllTemplatePagesByMenu($menu=null){
		$data = array();
		$this->db->order_by('added');
	...
	public function setTemplatePage($object=null){
	...
	// Delete page
	public function deleteTemplatePage($id) {
