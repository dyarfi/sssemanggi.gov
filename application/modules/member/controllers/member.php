...
class Member extends Admin_Controller {
    ...
    public function index() {
	    ...
	    // Set our Grocery CRUD
            ...
            // Set column
            $crud->columns('identity','fullname','email','phone_number','address','province','urbandistrict','suburban','join_date');
            
            // Set fields
            $crud->fields('identity','fullname','email','phone_number','address','province','urbandistrict','suburban','join_date');
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            // Set Members Title 
            $output->page_title = 'Members Listings';
            // Set Main Template
