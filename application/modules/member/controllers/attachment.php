...
class Attachment extends Admin_Controller {
    ...
    public function __construct() {
            ...
            // Load Gallery model
            $this->load->model('member/Attachments');
    ...
    public function index() {
        try {
            ...
            // Set table relation
            $crud->set_relation('member_id','tbl_members','email');
            // Set column
			$crud->columns('type', 'member_id','file_name','status','added','modified');
			...
			// Set upload field
            $crud->set_field_upload('file_name','uploads/members');
