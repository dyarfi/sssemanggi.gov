...
<header id="mocha-head" class="header">
            ...
            <div class="container">
                    ...
                    <div class="row">
                            <div class="span12">
                                    <div class="logo">
                                        <a href="index.html"><img src="img/logo.png" alt="Mocha"></a>
                                    ...
                                    <nav class="menu">
                                            <ul>
                                                ...
                                                <li><a href="page.html">About Us</a>
                                                    <ul>
                                                        <li><a href="portfolio.html">History</a></li>
                                                        <li><a href="portfolio-single.html">Boards of Directors</a></li>
                                                    </ul>
                                                </li>
            ...
            <div class="container">
                <div class="row home-portfolio-wrapper">
                            ...
                            <div class="section-title span12">
                                <h2>Our Portfolio</h2>
                                <a href="portfolio.html" class="section-link">Go to portfolio</a>
                            </div>
                            <!-- end section title -->
                            ...
                            <div class="portfolio-slider content-wrapper">
                                    ...
                                    <div class="span6 portfolio-item">
                                            ...
                                            <a href="portfolio-single.html" class="image">
                                                <img src="img/demo/portfolio1.png" alt="Brain Surgery">
                                            </a>
                                            <!-- end image -->
                                            <!-- title -->
                                    ...
                                    <div class="span6 portfolio-item">
                                            <!-- image -->
                                            <a href="portfolio-single.html" class="image">
                                                <img src="img/demo/portfolio2.png" alt="Web Design">
                                            </a>
                                            <!-- end image -->
                                            <!-- title -->
                                    ...
                                    <div class="span6 portfolio-item">
                                            <!-- image -->
                                            <a href="portfolio-single.html" class="image">
                                                <img src="img/demo/portfolio3.png" alt="Web Design">
                                            </a>
                                            <!-- end image -->
                                            <!-- title -->
                                            <a href="portfolio-single.html" class="title">Web Design <br /> <span class="meta">Graphic Design , Illustration</span></a>
